...
{
    public class DgOrganizationUnit 
        : OrganizationUnit, IFullAudited, IPassivable, IExtendableObject
    {
        ...
        #region IFullAudited, IPassivable, IExtendableObject 
        ...
        public DgOrganizationUnit(int? tenantId, string displayName, long? parentId = null)
        {
            TenantId = tenantId;
